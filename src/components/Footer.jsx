        ...
        <div className="w-full mx-auto flex flex-wrap">
          <div className="flex w-full lg:w-1/2">
            <div className="px-3 md:px-0">
              ...
              <p className="py-4">
                It is a project to put into practice concepts related to the
                creation of Rest APIs with .NET, C# and SQL, as well as the
                display of this data using TailwindCSS, React and Redux-Toolkit.
              </p>
            </div>
          </div>
